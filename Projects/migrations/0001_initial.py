    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Against', models.CharField(blank=True, choices=[('Purchases', 'Purchases'), ('Sales', 'Sales'), ('Expenses', 'Expenses'), ('Salaries', 'Salaries')], max_length=30, null=True)),
                ('Type', models.CharField(blank=True, choices=[('Vendor Invoice', 'Vendor Invoice'), ('Customer Invoice', 'Customer Invoice'), ('Vendor Payment', 'Vendor Payment'), ('Customer Payment', 'Customer Payment')], max_length=30, null=True)),
