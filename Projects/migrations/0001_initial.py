# Generated by Django 3.2.8 on 2022-06-28 11:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('No_Format_Related_To', models.CharField(choices=[('Invoice', 'Invoice'), ('PO', 'PO'), ('DC', 'DC'), ('Expenses Voucher', 'Expenses Voucher')], max_length=20, null=True)),
                ('PO_No_Format', models.CharField(help_text='excluding financial year and sequence number such as PS/AP/Service/ etc..', max_length=30, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Projects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Account_No', models.IntegerField(help_text='Bank Account Number', null=True)),
