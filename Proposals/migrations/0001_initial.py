# Generated by Django 3.2.8 on 2022-04-16 12:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Phone_Number', models.CharField(blank=True, help_text='10 Digit Main Phone Number', max_length=10, null=True)),
                ('Address_Line_1', models.CharField(blank=True, help_text='Address Line 1', max_length=40, null=True)),
                ...
                ('Type', models.CharField(blank=True, choices=[('Residential', 'Residential'), ('Commercial', 'Commercial')], help_text='Choose Wether it Resedential or Commercial', max_length=40, null=True)),
                ('Capacity', models.ForeignKey(help_text='Choose Your Required Capacity in KW', null=True, on_delete=django.db.models.deletion.CASCADE, to='Proposals.powercat')),
            ],
        ),
        migrations.CreateModel(
            name='Quote',
