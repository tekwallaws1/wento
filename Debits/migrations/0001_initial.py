    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OT', models.FloatField(blank=True, default=0, max_length=5, null=True)),
                ('Day_Status', models.CharField(blank=True, choices=[('Present', 'Present'), ('Absent', 'Absent'), ('Leave', 'Leave'), ('Half Day', 'Half Day'), ('Permission', 'Permission'), ('Tour', 'Tour')], default='Present', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Related_To', models.CharField(blank=True, choices=[('Services', 'Services'), ('Marketing', 'Marketing'), ('Office', 'Office'), ('Salary Advance', 'Salary Advance'), ('Dispatches', 'Dispatches'), ('EMI', 'EMI'), ('Others', 'Others')], max_length=30, null=True)),
                ('Against', models.CharField(blank=True, choices=[('Travel', 'Travel'), ('Food', 'Food'), ('Lodging', 'Lodging'), ('Fuel', 'Fuel'), ('Repair', 'Repair'), ('Transportation', 'Transportation'), ('Recharges', 'Recharges'), ('Stationery', 'Stationery'), ('General Purchase', 'General Purchase'), ('Miscellaneous', 'Miscellaneous'), ('Advances', 'Advances')], max_length=30, null=True)),
                ...
                ('Reference_No', models.CharField(blank=True, help_text='cheque number/transaction number etc if available', max_length=60, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Category', models.CharField(choices=[('Travel', 'Travel'), ('Food', 'Food'), ('Lodging', 'Lodging'), ('Fuel', 'Fuel'), ('Repair', 'Repair'), ('Transportation', 'Transportation'), ('Recharges', 'Recharges'), ('Stationery', 'Stationery'), ('General Purchase', 'General Purchase'), ('Miscellaneous', 'Miscellaneous'), ('Advances', 'Advances')], max_length=30, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Gross_Salary', models.IntegerField(blank=True, default=0, help_text='master gross salary', null=True)),
                ('Month', models.DateField(blank=True, null=True)),
                ('Issued_Days', models.FloatField(blank=True, default=0, max_length=5, null=True)),
                ('Issued_Salary', models.IntegerField(blank=True, default=0, help_text='issued salary or net salary for this month', null=True)),
                ('Issued_Date', models.DateField(help_text='salary issued date', null=True)),
                ('LOP', models.FloatField(blank=True, default=0, help_text='loss of pay if eligible', max_length=10, null=True)),
                ('OT_Amount', models.IntegerField(blank=True, default=0, help_text='over time amount if eligible', null=True)),
                ('OT_Hours', models.FloatField(blank=True, default=0, help_text='over time hours if eligible', max_length=5, null=True)),
                ...
                ('Deducted_Advance', models.FloatField(blank=True, default=0, help_text='deducted advances', max_length=10, null=True)),
                ('Special_Allowance', models.FloatField(blank=True, default=0, help_text='added special allowances if any', max_length=10, null=True)),
                ('Tour_Allowance', models.FloatField(blank=True, default=0, help_text='per day tour allowances', max_length=10, null=True)),
                ...
                ('Actual_Net_Salary', models.IntegerField(blank=True, null=True)),
                ('Expenses', models.FloatField(blank=True, default=0, max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('To_Date', models.DateField(blank=True, help_text='end date', null=True)),
                ('Related_To', models.CharField(choices=[('Services', 'Services'), ('Supplies', 'Supplies'), ('Factory', 'Factory'), ('Marketing', 'Marketing'), ('Office', 'Office'), ('Dispatches', 'Dispatches'), ('EMI', 'EMI'), ('Others', 'Others')], max_length=30, null=True)),
