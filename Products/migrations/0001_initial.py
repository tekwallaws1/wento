# Generated by Django 3.2.8 on 2022-06-28 11:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Warranty_In', models.CharField(blank=True, choices=[('Months', 'Months'), ('Years', 'Years'), ('Days', 'Days')], max_length=20, null=True)),
                ...
                ('Attach', models.FileField(blank=True, help_text='attach order copy if available', null=True, upload_to='po/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Invoice_No', models.CharField(blank=True, help_text='vendor issued invoice no against po', max_length=30, null=True, unique=True)),
                ...
                ('GST_Amount', models.FloatField(blank=True, help_text='GST Amount', max_length=10, null=True)),
                ...
                ('Attach', models.FileField(blank=True, help_text='attach order copy if available', null=True, upload_to='poinvoices/')),
                ('PO_No', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Products.purchases')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Product_Name', models.TextField(help_text='product name', max_length=1000, null=True, unique=True)),
                ...
                ('Make', models.CharField(blank=True, help_text='product make', max_length=50, null=True)),
                ('Model_No', models.CharField(blank=True, help_text='Model No/Part No/Ref No', max_length=30, null=True)),
                ('Serial_No', models.CharField(blank=True, help_text='product serial number if available', max_length=30, null=True, unique=True)),
                ('BOM_No', models.CharField(blank=True, help_text='BOM No for your internal reference', max_length=15, null=True, unique=True)),
                ('UOM', models.CharField(choices=[('No', 'No'), ('Set', 'Set'), ('Kg', 'Kg'), ('Mtr', 'Mtr'), ('Ltr', 'Ltr'), ('Bag', 'Bag')], max_length=15, null=True)),
                ('Date', models.DateTimeField(blank=True, help_text='product added/updated date', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('HSN_Code', models.FloatField(blank=True, help_text='HSN/SAC Code for this product', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Movement', models.CharField(choices=[('Added', 'Added'), ('Deleted', 'Deleted')], max_length=15, null=True)),
                ('Date', models.DateTimeField(blank=True, help_text='product added/updated date', null=True)),
                ('Stock', models.FloatField(blank=True, help_text='Present Stock', max_length=10, null=True)),
                ...
                ('Inward_Ref_PO', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Products.purchases')),
                ('Product_Name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Products.products')),
                ('Related_Order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Orders.orders')),
